...
# Use a function
QCwellDepth = '6643edfd604ca19527c90ab2'
QCRainfall = '6643edfd71c87fcf1f4b0a37'

QCrain = myfunctions.get_datapoints(JVRainfall,"2024-02-01T00:00:00",ends_before=time_format(),time_type ='local',name='default')
QCWell = myfunctions.get_datapoints(JVwellDepth,"2024-02-01T00:00:00",ends_before=time_format(),time_type ='local',name='default')
...
T5rain = myfunctions.get_datapoints(T3Rainfall,"2024-02-01T00:00:00",ends_before=time_format(),time_type ='local',name='default')
T5Well = myfunctions.get_datapoints(T3wellDepth,"2024-02-01T00:00:00",ends_before=time_format(),time_type ='local',name='default')
