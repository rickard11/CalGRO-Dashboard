...
# Use a function
E2well_ID = '66439575eb2fb4cd16ab5316'
E2Rainfall_ID = '66439fec826756b8928ced5e'

E2rain = myfunctions.get_datapoints(E2Rainfall_ID,"2024-02-01T00:00:00",ends_before=time_format(),time_type ='local',name='default')

E2Well = myfunctions.get_datapoints(E2well_ID,"2024-02-01T00:00:00",ends_before=time_format(),time_type ='local',name='default')
```
