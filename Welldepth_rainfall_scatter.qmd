...
```{r, loadE5data}
E5R<-read.csv("data/raw/other CalGro Sites/Rain/Escondido 5 Rain Gauge Rain Gauge 20231001-20250417.csv")
...
E5RN<-read.csv("data/raw/other CalGro Sites/Rain/Dangermond- Escondido 5 new Rain Gauge 20231001-20250417.csv")
...
#Uploading well data
E5W<-read.csv("data/raw/other CalGro Sites/Well/Dangermond- Escondido 5 Well 20231001-20250417.csv")
...
```{r,dataE3}
Uploading rain data
E3R<-read.csv("data/raw/other CalGro Sites/Rain/Dangermond- Escondido 3 Rain Gauge 20240131-20250401.csv")
